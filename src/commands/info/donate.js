        ...
        const embed = new EmbedBuilder()
            ...
            .addFields({
                ...
                value: [
                    ...
                    "We use [Placeholder](https://www.google.com) for donating."
                ].join("\n\n")},
                {
                    ...
                    value: [
                        ...
                        "If you connect your Placeholder account with Discord, you can get a Donator role and access to donator-only channels in our Discord."
                    ].join("\n\n")
                })
